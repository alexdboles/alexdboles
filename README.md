# Alex — Software Project Portfolio

I build practical applications around real workflows: sales practice, operations, planning, and decision support. This portfolio includes Python desktop tools, full-stack web applications, AI integrations, and IBM coursework.
...
These projects include AI-assisted development. I use AI tools alongside iterative review, integration, and testing; I do not present generated code as entirely hand-written. Project documentation explains the implementation, validation, and remaining limitations. Coursework retains its attribution.

The featured repositories include setup instructions and verification notes. Optional provider integrations need configuration; passing automated checks is not a guarantee of production readiness.
